...
})(
  {
      ...
      function (require, module, exports) {
        ...
        var o = function (o) {
          mapboxgl.accessToken =
            'pk.eyJ1IjoibWFuaXJlbmdhMyIsImEiOiJjbDBiaDdvNjMwOXo5M2l0MzVnYXJrdGJpIn0.cot3cBlCKaBhtWTtQp5dVg';
          var e = new mapboxgl.Map({
              container: 'map',
              style: 'mapbox://styles/manirenga3/cl0bhii4m000615pcsls3jz9b',
              scrollZoom: !1,
            }),
    ...
    zIVT: [
      function (require, module, exports) {
        ...
        function u(r) {
          return '[object FormData]' === t.call(r);
        }
        function c(r) {
          return 'undefined' != typeof ArrayBuffer && ArrayBuffer.isView
            ? ArrayBuffer.isView(r)
            : r && r.buffer && i(r.buffer);
        }
        function f(r) {
        ...
        function v(r) {
          return '[object URLSearchParams]' === t.call(r);
        }
        function m(r) {
    ...
    AxoZ: [
      function (require, module, exports) {
        ...
        function n(e, t, r, n, s, a, o) {
          ...
          u.done ? t(i) : Promise.resolve(i).then(n, s);
        }
        function s(e) {
          return function () {
            var t = this,
                        ...
                        return (
                          ...
                          (a =
                            'login' === s
                              ...
                              : '/api/v1/users/signup'),
                          (r.next = 4),
                          (0, e.default)({ method: 'POST', url: a, data: n })
                        );
                      case 4:
                        'success' === (o = r.sent).data.status &&
                          ('login' === s
                            ? ((0, t.showAlert)('success', o.data.message),
                    ...
                    switch ((r.prev = r.next)) {
                      ...
                      case 7:
                        (r.prev = 7),
                          ...
                          (0, t.showAlert)(
                            'error',
                            'Error in logging out! Try again.'
                          );
                      case 10:
                      case 'end':
                        return r.stop();
    ...
    yPfX: [
      function (require, module, exports) {
        ...
        var s = (function () {
          var r = a(
            regeneratorRuntime.mark(function r(n, a) {
              var s;
              return regeneratorRuntime.wrap(
                function (r) {
                  for (;;)
                    switch ((r.prev = r.next)) {
                      case 0:
                        return (
                          ...
                          (r.next = 4),
                          (0, e.default)({ method: 'PATCH', url: s, data: n })
                        );
                      case 4:
                        'success' === r.sent.data.status &&
                          ((0, t.showAlert)(
                            'success',
                            ''.concat(a, ' updated successfully')
                          ),
                          window.setTimeout(function () {
                            location.assign('/me');
                          }, 1e3)),
    ...
    Focm: [
      function (require, module, exports) {
        ...
        var e = require('./mapbox.js'),
          r = require('./auth.js'),
          s = require('./updateData.js'),
          o = require('./stripe.js'),
          t = require('./alerts.js');
        function u(e, r, s, o, t, u, i) {
          try {
            var n = e[u](i),
              c = n.value;
          } catch (j) {
        ...
        var n = document.getElementById('map'),
          c = document.querySelector('.form-user-login'),
          j = document.querySelector('.form-user-signup'),
          a = document.querySelector('.nav__el--logout'),
          l = document.querySelector('.form-user-data'),
          m = document.querySelector('.form-user-settings'),
          d = document.getElementById('photo'),
          q = document.querySelector('.btn--choose-photo'),
          p = document.getElementById('book-tour');
        if (n) {
          var f = JSON.parse(n.dataset.locations);
          (0, e.displayMap)(f);
        }
        c &&
          c.addEventListener(
                  ...
                  return regeneratorRuntime.wrap(function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (document.querySelector('.btn--login').textContent =
                              'Logging in...'),
                            s.preventDefault(),
                            (o = document.getElementById('loginEmail').value),
                            (t =
                              document.getElementById('loginPassword').value),
                            (e.next = 6),
                            (0, r.auth)({ email: o, password: t }, 'login')
                          );
                        case 6:
                          document.querySelector('.btn--login').textContent =
                            'Login';
          ...
          a && a.addEventListener('click', r.logout),
          q &&
          ...
          d &&
            d.addEventListener('change', function () {
              var e = this.files[0];
              e && new FileReader().readAsDataURL(e);
              if (this.value) {
                var r = this.value.match(
                  /[0-9a-zA-Z\^\&\'\@\{\}\[\]\,\$\=\!\-\#\(\)\.\%\+\~\_]+$/
                );
                document.getElementById('file-name').textContent = r;
              }
            }),
          l &&
            l.addEventListener(
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              ...
                              o.append('photo', d.files[0]),
                              (e.next = 7),
                              (0, s.updateData)(o, 'Data')
                            );
                          case 7:
                            document.querySelector(
                              '.btn--save-data'
